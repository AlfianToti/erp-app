        ...
        <div class="modal-content bg-white rounded-xl p-8 shadow-lg border-0" style="overflow: visible;">
            ...
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="customer_id" value="{{ old('customer_id') }}" style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter your ID">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter your name">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" style="background-color: #f3f4f6; border: none; border-radius: 12px; padding: 12px 16px; width: 100%; outline: none;" placeholder="Enter your email">
